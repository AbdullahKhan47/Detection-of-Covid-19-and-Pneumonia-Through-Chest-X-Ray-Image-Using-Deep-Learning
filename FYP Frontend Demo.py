            ...
            if re.search(pattern2, a_age):
                ...
                if re.search(pattern3, a_cnic):
                     ...
                     #testing of covid pneumonia
                      ...
                      lbl10=Label(wrapper4,text=timeprint) # %I is for time format for 12 hrs, %H is for 24 hrs
...
btn2=Button(wrapper2,text="Browse Image", command=showimage).grid(row=1,column=0,padx=10,pady=10)
